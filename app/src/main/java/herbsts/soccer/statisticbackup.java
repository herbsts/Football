...
public class statisticbackup implements Comparable<statisticbackup> {
    private int id = -1;
    ...
    public statisticbackup(Match match, int goalsShot, int goalsPenalty, int goalsHead, int goalsHeadSnow, int goalsOwn, int nutmegs) {
        this.id = ++idCounter;
        this.match = match;
    ...
    public statisticbackup(Match match)
    {
        this.match = match;
    }
    ...
    @Override
    public int compareTo(@NonNull statisticbackup s) {
